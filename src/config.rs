...
pub const RENDEZVOUS_SERVERS: &[&str] = &["ts.yccz.top"];
pub const RS_PUB_KEY: &str = "Pc468y8Ywc3dbcAxJ8H5BO3ypY6xok7IU6k7ojfc07U=";
...
pub mod keys {
    ...
    pub const OPTION_DEFAULT_CONNECT_PASSWORD: &str = "8191743Xx";
